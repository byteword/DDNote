#ifndef __DDNOTE__TYPE_INFO__H__INCLUDDED__
#define __DDNOTE__TYPE_INFO__H__INCLUDDED__
#pragma once

struct DDTypeInfo
{
	// category of type
	enum E_CATEGORY { NONE, SCALAR, OBJECT };
	unsigned int _cat;
...
#endif //__DDNOTE__TYPE_INFO__H__INCLUDDED__
